...
const ProjectDetailsModal: React.FC<ProjectDetailsModalProps> = ({ 
  ...
  const [registrationModal, setRegistrationModal] = React.useState<{
    isOpen: boolean;
  ...
  const generateProjectDetails = (projectId: string, projectName: string) => {
    ...
    return {
      ...
      milestones: [
        { date: 'Q1 2025', title: 'Project Inception', completed: true },
        { date: 'Q2 2025', title: 'MVP Development', completed: true },
        { date: 'Q3 2025', title: 'Beta Testing', completed: project.stage === 'Beta' || project.stage === 'Production' },
        { date: 'Q4 2025', title: 'Production Launch', completed: project.stage === 'Production' }
      ],
      metrics: {
        accuracy: '98.5%',
        uptime: '99.9%',
  ...
  return (
    <>
      ...
      <RegistrationModal
        ...
        actionType={registrationModal.actionType}
