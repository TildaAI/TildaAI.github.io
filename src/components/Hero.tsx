        ...
        <div className="text-center space-y-8 max-w-4xl mx-auto">
          ...
          <div className="animate-fade-in grid grid-cols-3 gap-8 pt-16 max-w-2xl mx-auto" style={{ animationDelay: '0.8s' }}>
            <div className="text-center liquid-glass rounded-2xl p-6 animate-morph stats-glow">
              <div className="text-3xl font-bold text-ethereal-blue text-shadow-glow">24</div>
            ...
            <div className="text-center liquid-glass rounded-2xl p-6 animate-morph stats-glow" style={{ animationDelay: '0.2s' }}>
              <div className="text-3xl font-bold text-ethereal-blue text-shadow-glow">62K</div>
          ...
          <div className="animate-fade-in pt-12" style={{ animationDelay: '1s' }}>
            <button
              ...
              className="text-gray-300 hover:text-ethereal-blue transition-colors duration-300 text-lg font-medium hero-text"
            >
              How does it work?
            </button>
          </div>
